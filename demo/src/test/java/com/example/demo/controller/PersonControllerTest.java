...
class PersonControllerTest {
        ...
        public void testGetPeople() throws Exception {
                ...
                people.add(new Person("Michael", "Wood", "January 28, 1973", "3664 Vineyard Drive", "Cleveland", "Ohio",
                                44115, "440-457-6732"));
                people.add(new Person("Rodney", "Bonilla", "November 9, 1945", "1419 Cambridge Court", "Phoenix",
                                "Arizona", 85034, "480-200-1008"));
        ...
        public void testGetPerson() throws Exception {
                Person person = new Person("Michael", "Wood", "January 28, 1973", "3664 Vineyard Drive", "Cleveland",
                                "Ohio", 44115, "440-457-6732");
        ...
        public void testAddPerson() throws Exception {
                ...
                Person person = new Person("John", "Doe", "January 1, 1990", "123 Main St", "City", "State", 12345,
                                "123-456-7890");
                ...
                MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/people")
                                ...
                                .content("{\"firstName\":\"John\",\"lastName\":\"Doe\",\"birthdate\":\"January 1, 1990\",\"address\":\"123 Main St\",\"city\":\"City\",\"state\":\"State\",\"zip\":12345,\"phone\":\"123-456-7890\"}");
        ...
        public void testUpdatePerson() throws Exception {
                ...
                MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/people/0")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"firstName\":\"Updatedd\",\"lastName\":\"Personn\",\"birthday\":\"February 2, 2000\",\"address\":\"456 New St\",\"city\":\"New City\",\"state\":\"New State\",\"zipCode\":54321,\"phoneNumber\":\"987-654-3210\"}");
