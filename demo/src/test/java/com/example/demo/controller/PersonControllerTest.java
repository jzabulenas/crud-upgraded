...
class PersonControllerTest {
    ...
    public void testAddPerson() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
                ...
                .content("{\"firstName\":\"John\",\"lastName\":\"Doe\",\"birthdate\":\"January 1, 1990\",\"address\":"
                        + "\"123 Main St\",\"city\":\"City\",\"state\":\"State\",\"zip\":12345,\"phone\":\"123-456-7890\"}");
    ...
    public void testUpdatePerson() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
                .put("/people/0")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"firstName\":\"Updatedd\",\"lastName\":\"Personn\",\"birthday\":\"February 2, 2000\","
                        + "\"address\":\"456 New St\",\"city\":\"New City\",\"state\":\"New State\","
                        + "\"zipCode\":54321,\"phoneNumber\":\"987-654-3210\"}");
